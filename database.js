...
const connectDB = async () => {
    ...
    try {
        const uri = process.env.MONGO_URI || 'mongodb+srv://avishkamihiranga1230_db_user:VXUw96emoPUVM8ea.@cluster0.56waxjy.mongodb.net/?appName=Cluster0';
